...
var USER = {
  ...
  addHideButton: function addHideButton(_ref2) {
    ...
    var hideAllPostsButton = NODE_BUILDER.hideAllPostsButton({ userId: userId, userName: userName });
...
if (logoutLink) {
  (function () {
    ...
    tableRowsWithoutElectraAds.forEach(function (item) {
      ...
      var siteData = { postId: postId, userId: userId, userName: userName, item: item };
